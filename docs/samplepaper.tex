...
\begin{thebibliography}{8}
    ...
    \bibitem{ref_vndoc}
    Tuan, D.V.: Vietnamese Document Embedding measures. HuggingFace Hub (2023). \url{https://huggingface.co/dangvantuan/vietnamese-document-embedding}

    \bibitem{ref_visobert}
    Nguyen, Q., et al.: ViSoBERT: A Pre-trained Language Model for Vietnamese Social Media Text. In: EMNLP (2023)
