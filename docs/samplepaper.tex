...
\begin{itemize}
    \item \textbf{News Article Collection:} We developed custom Python web scrapers for five major Vietnamese news outlets: VnExpress, Tuoi Tre, Thanh Nien, Nguoi Lao Dong, and VietnamNet. Each scraper implements:
          \begin{itemize}
