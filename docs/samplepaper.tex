...
\begin{abstract}
    ...
    On a \textbf{Mini-Ground Truth} subset (N=300 manually labeled social posts), our full hybrid pipeline achieves \textbf{NMI = 0.598}.
...
After content extraction, \textbf{4,603 news articles} contain valid body text and are used for anchoring and embedding.
