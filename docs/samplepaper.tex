...
\begin{abstract}
    ...
    Experimental results on a Mini-Ground Truth subset (N=300 manually labeled social posts) show our method achieves an NMI of 0.54 and Purity of 0.65. 
    On the full dataset of 7,605 items, we further report intrinsic clustering metrics and an LLM-as-a-Judge framework to evaluate semantic coherence.
