...
\title{Hệ thống Phát hiện và Phân loại Xu hướng Thời gian Thực: Tích hợp Luồng Mạng Xã hội và Tin tức Chính thống với Trí tuệ LLM}
...
% Config page header
\makeatletter
\@ifundefined{if@twoside}{}{\if@twoside
