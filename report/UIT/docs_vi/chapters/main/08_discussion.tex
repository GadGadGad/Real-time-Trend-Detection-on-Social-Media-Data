...
\begin{itemize}
    ...
    \item \textbf{Không có Heuristic Guard:} Việc vô hiệu hóa bộ lọc regex ban đầu đã làm tăng số lượng cụm lên 300\%, nhưng phần lớn là ``rác'' (xổ số, thời tiết), khiến điểm F1 giảm 60\%.
