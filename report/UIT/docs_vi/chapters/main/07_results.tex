...
\begin{itemize}
    ...
    \item \textbf{Prompting:} Chúng tôi sử dụng chiến lược ``Role-Play'' nơi LLM đóng vai như một biên tập viên tin tức chuyên gia. Đặc tả prompt đầy đủ được cung cấp trong Phụ lục Bảng \autoref{tab:prompt_eval}.
\end{itemize}
