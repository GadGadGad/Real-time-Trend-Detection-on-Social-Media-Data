...
Bảng \ref{tab:related_work} tổng hợp so sánh các đại diện tiêu biểu theo các tiêu chí: mức độ hiểu ngữ nghĩa, khả năng thời gian thực, xử lý nhiễu, tính diễn giải và khả năng mở rộng.
...
Tổng hợp từ Bảng \ref{tab:related_work}, có một đánh đổi phổ biến: các phương pháp đạt \emph{độ trễ thấp} thường dựa vào đặc trưng nhẹ và thiếu nhất quán ngữ nghĩa; ngược lại, các phương pháp dùng LLM đạt \emph{diễn giải/hiểu ngữ nghĩa} tốt nhưng khó đáp ứng yêu cầu thời gian thực do chi phí suy luận.
