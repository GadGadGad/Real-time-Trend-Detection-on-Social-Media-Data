...
\section{Định nghĩa Bài toán Hình thức}
...
\subsection{Triển khai Thu thập với Apache Airflow}
...
\subsection{Pipeline Dữ liệu với Apache Kafka}
...
\subsection{Chiến lược Tiền xử lý Dữ liệu}
...
\section{Phân cụm Phân cấp Nhận thức Xã hội (SAHC)}
...
\section{Logic Tính Điểm Xu hướng}
