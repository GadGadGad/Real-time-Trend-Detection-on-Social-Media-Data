...
\subsection{Acquisition Deployment with Apache Airflow}
...
\subsection{Data Pipeline with Apache Kafka}
...
\section{Social-Aware Hierarchical Clustering (SAHC)}
