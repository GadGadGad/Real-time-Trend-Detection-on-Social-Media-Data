    ...
    \begin{itemize}
        \item \textbf{1. Sentiment Analysis (4,630 samples):}
              \begin{itemize}
                  ...
                  \item Pseudo-labeling bằng Gemini-3-Pro, sau đó **Human Review** các trường hợp có độ tin cậy thấp.
              \end{itemize}
    ...
    \begin{table}[]
        ...
        \resizebox{\textwidth}{!}{%
            \begin{tabular}{l c c c c c l}
                ...
                \midrule
                KMEANS                  & 253          & 0              & 0.024               & 3.177             & \textbf{8.45}     & Chất lượng cụm kém + Số lượng cụm cố định(Không phù hợp với bài toán) \\
