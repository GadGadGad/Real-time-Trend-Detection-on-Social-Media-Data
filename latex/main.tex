  ...
  \begin{columns}
    ...
    \begin{alertblock}{Vấn đề còn tồn tại}
      \begin{itemize}
        ...
        \item \textbf{Phụ thuộc danh sách từ khoá xu hướng, nên kém hiệu quả với các trend mới hoàn toàn.}
      \end{itemize}
    \end{alertblock}
  \end{columns}
  ...
  \begin{table}
    ...
    {@{\hspace{6pt}}p{0.1\textwidth}
     ...
     p{0.22\textwidth}@{\hspace{6pt}}}
      ...
      \midrule
      Task 1 & \raggedright Chuẩn hoá schema + làm sạch cơ bản (Unicode/boilerplate) & Đang làm \\

      Task 2 & \raggedright Thu thập dữ liệu (Crawler) & \textbf{Đã hoàn thành} \\

      Task 3 & \raggedright Semantic matching (embedding) + alias/NER enrichment & Đang thử nghiệm \\

      Task 4 & \raggedright Tối ưu Clustering (UMAP + HDBSCAN) + đánh giá chất lượng cụm & Đang tìm giải pháp tối ưu hơn \\

      Task 5 & \raggedright Xác định tên trend và tóm tắt thông tin cốt lõi của trend & TBD \\

      Task 6 & \raggedright Phân tích cảm xúc, tâm lý từ trend đã phát hiện & TBD \\

      Task 7 & \raggedright Trend scoring + phân loại trend đa nguồn & TBD \\
