...
\begin{frame}{Kiến trúc hệ thống dự kiến}
  ...
  \begin{columns}
    ...
    \begin{itemize}
      ...
      \item \textbf{Phân tích cảm xúc / tâm lý cộng đồng theo từng trend}.
  ...
  \begin{table}
    ...
    {@{\hspace{6pt}}p{0.1\textwidth}
     ...
     p{0.22\textwidth}@{\hspace{6pt}}}
      ...
      \midrule
      Task 1 & \raggedright Chuẩn hoá schema + làm sạch dữ liệu (Unicode, nội dung mẫu lặp) & Đang làm \\

      Task 2 & \raggedright Thu thập dữ liệu đa nguồn (Crawler / Apify / News) & \textbf{Đã hoàn thành} \\

      Task 3 & \raggedright Semantic matching (embedding) + tăng cường ngữ cảnh (NER / alias) & Đang thử nghiệm \\

      Task 4 & \raggedright Tối ưu Clustering (UMAP + HDBSCAN) + đánh giá chất lượng cụm & Đang tìm giải pháp tối ưu hơn \\

      Task 5 & \raggedright Đặt tên trend và tóm tắt thông tin cốt lõi cho mỗi cụm & TBD \\

      Task 6 & \raggedright Trend scoring + phân loại trend đa nguồn & TBD \\

      Task 7 & \raggedright Phân tích cảm xúc, tâm lý cộng đồng theo từng trend & TBD \\
